                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <li class="list-group-item"><a class="text-dark" href="#">Akutansi</a></li>
                                    <li class="list-group-item"><a class="text-dark" href="#">Ekonomi</a></li>
                                    <li class="list-group-item"><a class="text-dark" href="#">Kimia</a></li>
                                    <li class="list-group-item"><a class="text-dark" href="#">Hukum</a></li>
                                    <li class="list-group-item"><a class="text-dark" href="#">Elektro</a></li>
                                    <li class="list-group-item"><a class="text-dark" href="#">Mesin</a></li>
                                    </ul>
                                    <div class="card-body mb-0">
                                        <center>
...
<?php echo $__env->make('core.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mussafi/Laravel/web_arsip/resources/views/core/component/category/hukum/index.blade.php ENDPATH**/ ?>