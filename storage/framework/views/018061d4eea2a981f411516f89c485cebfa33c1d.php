                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            ...
                            <?php $__currentLoopData = $arsip_foot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="whats-right-single mb-20">
                                    <div class="whats-right-cap" style="width:100%;padding-left:0px;">
                                        <span class="colorb" style="font-weight:bold;"><?php echo e($a->kategori); ?></span>
                                        <h4><a href="latest_news.html"><?php echo e(substr($a->judul,0,44)); ?></a></h4>
...
<?php /**PATH /home/mussafi/Laravel/web_arsip/resources/views/core/layouts/footer.blade.php ENDPATH**/ ?>