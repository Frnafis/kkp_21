                    ...
                    <div class="col-md-11">
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-4" style="border-radius:10px;box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;;padding-left:0px;padding-right:0px;overflow:hidden;">
                                <img style="" src="<?php echo e(asset('assets/img/arsip.jpg')); ?>" class="img-fluid">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="row">
                                                    <?php $__currentLoopData = array_slice($arsip->toArray(), 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single mb-20">
                                                                <div class="whats-right-cap">
                                                                    <span class="colorb"><?php echo e($a["kategori"]); ?></span>
                                                                    <h4><a href="<?php echo e(route('archive.content',$a['judul'])); ?>"><?php echo e(substr($a["judul"],0,55)); ?></a></h4>
                                                                    <p><?php echo e(\Carbon\Carbon::parse($a["created_at"])->format("F d, Y")); ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="row">
                                                    <?php $__currentLoopData = array_slice($arsip->toArray(), 4, 7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single mb-20">
                                                                <div class="whats-right-cap">
                                                                    <span class="colorg"><?php echo e($f["kategori"]); ?></span>
                                                                    <h4><a href="latest_news.html"><?php echo e(substr($f["judul"],0,55)); ?></a></h4>
                                                                    <p><?php echo e(\Carbon\Carbon::parse($f["created_at"])->format("F d, Y")); ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('core.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mussafi/Laravel/web_arsip/resources/views/core/welcome.blade.php ENDPATH**/ ?>