    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <form class="row" action="{{route('users.lecture.update', $user->id)}}" method="POST">
            @csrf
            <div class="form-group col-md-12">
              <label for="name">Fullname</label>
              <input type="name"  class="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter name" required name="name" value="{{$user->name}}">
            </div>
            <div class="form-group col-md-12">
              <label for="email">Email</label>
              <input type="email"  class="form-control" id="email" placeholder="Enter email" required name="email" value="{{$user->email}}">
            </div>
